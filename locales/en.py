...
STRINGS = {
    ...
    "progress_label_track": "Track",
    "progress_label_download": "Downloading",
    "progress_label_playlist": "Playlist",
    "progress_label_similar": "Similar",
    "progress_label_lyrics": "Lyrics",
    "progress_label_discover": "Discover",
    "progress_searching": "Searching...",
    "progress_searching_n": "Searching ({current}/{total})...",
    "progress_downloading": "Downloading...",
    "progress_downloading_audio": "Downloading audio...",
    "progress_preparing_link": "Preparing download link...",
    "progress_starting_download": "Starting download...",
    "progress_tagging": "Tagging and cover art...",
    "progress_sending": "Sending to Telegram...",
    "progress_ready": "Ready",
    "progress_cache_fast": "Sending quickly from cache...",
    "progress_ready_send": "Ready to send to Telegram...",
    "progress_search_download": "Searching and downloading...",
    "progress_preparing": "Preparing...",
    "progress_fetching_lyrics": "Fetching lyrics...",
    ...
    "changelog_empty": "No pending changelog notes.",
    "changelog_llm_unavailable": (
        "Pending changelog notes exist, but the LLM is not configured.\n"
        "Set LLM_API_KEY / LLM_API_BASE, then restart — or skip to archive the notes."
    ),
    "changelog_llm_failed": (
        "Could not generate the changelog with the LLM. Pending notes were left in place."
    ),
