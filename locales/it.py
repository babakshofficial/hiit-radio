...
STRINGS = {
    ...
    "help_text": (
        ...
        "Invia /stop in qualsiasi momento per fermare un download."
    ),
    "aboutme_text": (
        "🎙 Info su HiiT Radio\n"
        "\n"
    ...
    "too_many_jobs": (
        ...
        "Aspetta che finiscano oppure fermale con /stop."
    ),
    ...
    "grant_user_notice": (
        "🎁 Hai ricevuto {days} giorni di {tier}, attivo fino al {expires}.\n"
        "Invia un brano quando vuoi."
    ),
    "topup_user_notice": (
        "🎁 Sono stati aggiunti +{amount} download extra al tuo account per oggi ({day})."
    ),
    "grant_notify_failed": (
        "⚠️ Impossibile avvisare l'utente — forse deve prima avviare il bot."
    ),
    ...
    "playlist_capped": (
        "Questa playlist ha {original} brani. Invio solo i primi {limit}."
    ),
    ...
    "progress_label_track": "Brano",
    "progress_label_download": "Download",
    "progress_label_playlist": "Playlist",
    "progress_label_similar": "Simili",
    "progress_label_lyrics": "Testo",
    "progress_label_discover": "Scopri",
    "progress_searching": "Ricerca in corso...",
    "progress_searching_n": "Ricerca ({current}/{total})...",
    "progress_downloading": "Download in corso...",
    "progress_downloading_audio": "Download dell'audio...",
    "progress_preparing_link": "Preparazione del link...",
    "progress_starting_download": "Avvio del download...",
    "progress_tagging": "Tag e copertina...",
    "progress_sending": "Invio a Telegram...",
    "progress_ready": "Pronto",
    "progress_cache_fast": "Invio rapido dalla cache...",
    "progress_ready_send": "Pronto per l'invio a Telegram...",
    "progress_search_download": "Ricerca e download...",
    "progress_preparing": "Preparazione...",
    "progress_fetching_lyrics": "Recupero del testo...",
    ...
    "awiz_cancel": "❌ Annulla",
    "awiz_confirm": "✅ Conferma",
    "awiz_cancelled": "Annullato.",
    "awiz_invalid_user": "Non sembra un ID utente. Invia un numero, @username, o scegli sotto.",
    "awiz_pick_user": "A chi?\nInvia un ID o @username, oppure scegli un utente recente.",
    "awiz_grant_tier": "Grant per {user} — quale piano?",
    "awiz_tier_premium": "⭐ Premium",
    "awiz_tier_unlimited": "♾ Illimitato",
    "awiz_grant_days": "{user} → {tier}\nQuanti giorni?",
    "awiz_days_7": "7 giorni",
    "awiz_days_30": "30 giorni",
    "awiz_days_90": "90 giorni",
    "awiz_days_custom": "Personalizzato…",
    "awiz_grant_days_custom": "Invia il numero di giorni (es. 14).",
    "awiz_grant_confirm": "Concedere {tier} a {user} per {days} giorni?",
    "awiz_topup_amount": "Ricarica per {user} — quanti download extra?",
    "awiz_amt_default": "Predefinito ({amount})",
    "awiz_amt_custom": "Personalizzato…",
    "awiz_topup_amount_custom": "Invia il numero di download extra.",
    "awiz_topup_confirm": "Aggiungere +{amount} download oggi per {user}?",
    "awiz_broadcast_ask": "Invia il testo del broadcast nel prossimo messaggio.",
    "awiz_broadcast_empty": "Messaggio vuoto — invia il testo da inviare.",
    "awiz_broadcast_confirm": "Inviare questo a {count} utenti?\n\n{preview}",
    "awiz_broadcast_done": "Broadcast finito: inviati={sent}, falliti={failed}",
    "awiz_viplog_ask": "Stato log VIP:\n\n{status}\n\nInviare un messaggio di test al canale VIP?",
    "awiz_viplog_send": "🧪 Invia test",
    "awiz_reports_ask": "Segnalazioni — sfoglia l'elenco o invia un ID.",
    "awiz_reports_list": "📋 Elenco",
    "awiz_reports_id": "🔎 Inserisci ID",
    "awiz_reports_ask_id": "Invia l'ID della segnalazione (numero).",
    "awiz_reports_bad_id": "ID non valido. Invia un numero o torna indietro.",
    "awiz_user_ask": "Invia un ID o @username, oppure scegli un utente recente.",
    "awiz_channelid_ask": (
        "Inoltra qui un post del canale VIP (mantenendo il nome del mittente).\n"
        "Oppure invia /channelid nel canale."
    ),
    "awiz_channelid_need_forward": "Serve un post inoltrato dal canale. Inoltrane uno, o annulla.",
    "awiz_export_ask": "Esportare l'intero database in JSON?",
    "awiz_export_go": "📤 Esporta ora",

    # --- changelog broadcast ---
    "changelog_header": "✨ Novità di HiiT Radio",
    "changelog_admin_prompt": (
        "Dopo il riavvio ci sono note di changelog in attesa.\n"
        "Modificale se serve, poi Invia — avrai una scheda per lingua "
        "da rivedere, modificare, rigenerare o inviare separatamente. Oppure Salta per archiviare senza inviare."
    ),
    ...
    "changelog_btn_regenerate": "🔄 Rigenera",
    "changelog_review_started": "Rivedi ogni lingua sotto. Invia, salta, modifica o rigenera per lingua.",
    "changelog_lang_card": "{lang_name} ({count} utenti)\n\n{header}\n\n{body}",
    "changelog_lang_sent": "✅ Inviato: {sent} ok, {failed} falliti.",
    "changelog_lang_skipped": "⏭ Saltato per {lang_name}.",
    "changelog_lang_regenerating": "⏳ Rigenerazione {lang_name}…",
    "changelog_lang_edit_prompt": "Invia il messaggio changelog in {lang_name} nella prossima risposta.",
    "changelog_lang_edit_saved": "✅ Testo {lang_name} aggiornato.",
    "changelog_lang_edit_empty": "Messaggio vuoto — invia il testo changelog in {lang_name}.",
    "changelog_lang_llm_failed": "Impossibile generare il testo per {lang_name}. Rigenera o modifica manualmente.",
    "changelog_all_done": (
        "Tutte le lingue gestite. Inviate: {sent_langs}, saltate: {skipped_langs}. "
        "Messaggi agli utenti: {sent} ok, {failed} falliti."
    ),
    ...
    "changelog_empty": "Nessuna nota di changelog in attesa.",
    "changelog_llm_unavailable": (
        "Ci sono note di changelog, ma l'LLM non è configurato.\n"
        "Imposta LLM_API_KEY / LLM_API_BASE e riavvia — oppure salta per archiviare."
    ),
    "changelog_llm_failed": (
        "Impossibile generare il changelog con l'LLM. Le note restano in attesa."
    ),
