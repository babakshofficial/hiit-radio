...
STRINGS = {
    ...
    "help_text": (
        ...
        "۶. یا اینلاین: {bot_inline} نام آهنگ — توی هر چتی\n\n"
    ...
    "quality_status_footer": "یکی از دکمه‌ها رو بزن یا بنویس: /quality 320",
    ...
    "not_following": "هنوز هیچ هنرمندی رو دنبال نکردی — با /follow شروع کن!",
