...
STRINGS = {
    ...
    "help_text": (
        ...
        "هر وقت خواستی با /stop دانلود جاری را متوقف کن."
    ),
    "aboutme_text": (
        "🎙 درباره HiiT Radio\n"
        "\n"
    ...
    "too_many_jobs": (
        ...
        "صبر کن تموم بشه یا با /stop متوقفش کن."
    ),
    ...
    "grant_user_notice": (
        "🎁 اشتراک {tier} به مدت {days} روز تا {expires} به حسابت اضافه شد.\n"
        "هر وقت خواستی آهنگ بفرست."
    ),
    "topup_user_notice": (
        "🎁 +{amount} دانلود اضافه برای امروز ({day}) به حسابت اضافه شد."
    ),
    "grant_notify_failed": (
        "⚠️ پیام به کاربر نرسید — شاید هنوز ربات را استارت نکرده."
    ),
    ...
    "playlist_start": (
        "📋 شروع دانلود: {name}\n"
        "تعداد: {total} آهنگ\n\n"
        "/stop برای توقف کار جاری"
    ),
    "playlist_capped": (
        "این پلی‌لیست {original} آهنگ داره. فقط {limit} تای اول رو می‌فرستم."
    ),
    ...
    "progress_label_track": "آهنگ",
    "progress_label_download": "در حال دانلود",
    "progress_label_playlist": "پلی‌لیست",
    "progress_label_similar": "مشابه",
    "progress_label_lyrics": "متن آهنگ",
    "progress_label_discover": "پیشنهاد",
    "progress_searching": "در حال جستجو...",
    "progress_searching_n": "در حال جستجو ({current}/{total})...",
    "progress_downloading": "در حال دانلود...",
    "progress_downloading_audio": "در حال دانلود فایل صوتی...",
    "progress_preparing_link": "آماده‌سازی لینک دانلود...",
    "progress_starting_download": "شروع دانلود...",
    "progress_tagging": "برچسب‌گذاری و کاور...",
    "progress_sending": "در حال ارسال به تلگرام...",
    "progress_ready": "آماده شد",
    "progress_cache_fast": "ارسال سریع از کش...",
    "progress_ready_send": "آماده ارسال به تلگرام...",
    "progress_search_download": "در حال جستجو و دانلود...",
    "progress_preparing": "در حال آماده‌سازی...",
    "progress_fetching_lyrics": "در حال دریافت متن آهنگ...",
    ...
    "awiz_cancel": "❌ انصراف",
    "awiz_confirm": "✅ تأیید",
    "awiz_cancelled": "لغو شد.",
    "awiz_invalid_user": "این شناسه کاربر معتبر نیست. یک عدد، @username، یا یکی از کاربران زیر را بفرست.",
    "awiz_pick_user": "برای چه کسی؟\nشناسه کاربر یا @username بفرست، یا از لیست انتخاب کن.",
    "awiz_grant_tier": "گرنت برای {user} — کدام پلن؟",
    "awiz_tier_premium": "⭐ پریمیوم",
    "awiz_tier_unlimited": "♾ نامحدود",
    "awiz_grant_days": "{user} → {tier}\nچند روز؟",
    "awiz_days_7": "۷ روز",
    "awiz_days_30": "۳۰ روز",
    "awiz_days_90": "۹۰ روز",
    "awiz_days_custom": "دلخواه…",
    "awiz_grant_days_custom": "تعداد روز را بفرست (مثلاً ۱۴).",
    "awiz_grant_confirm": "گرنت {tier} برای {user} به مدت {days} روز؟",
    "awiz_topup_amount": "شارژ سهمیه {user} — چند دانلود اضافه؟",
    "awiz_amt_default": "پیش‌فرض ({amount})",
    "awiz_amt_custom": "دلخواه…",
    "awiz_topup_amount_custom": "تعداد دانلود اضافه را بفرست.",
    "awiz_topup_confirm": "برای {user} امروز +{amount} دانلود اضافه شود؟",
    "awiz_broadcast_ask": "متن پیام همگانی را در پیام بعدی بفرست.",
    "awiz_broadcast_empty": "متن خالی بود — پیام را بفرست.",
    "awiz_broadcast_confirm": "این متن برای {count} کاربر ارسال شود؟\n\n{preview}",
    "awiz_broadcast_done": "پیام همگانی تمام شد: ارسال‌شده={sent}، ناموفق={failed}",
    "awiz_viplog_ask": "وضعیت لاگ VIP:\n\n{status}\n\nیک پیام آزمایشی به کانال VIP بفرستم؟",
    "awiz_viplog_send": "🧪 ارسال تست",
    "awiz_reports_ask": "گزارش کاربران — لیست را ببین یا شناسه گزارش را بفرست.",
    "awiz_reports_list": "📋 مشاهده لیست",
    "awiz_reports_id": "🔎 ورود شناسه",
    "awiz_reports_ask_id": "شناسه گزارش را بفرست (عدد).",
    "awiz_reports_bad_id": "شناسه معتبر نیست. یک عدد بفرست یا برگرد.",
    "awiz_user_ask": "شناسه کاربر یا @username بفرست، یا از لیست انتخاب کن.",
    "awiz_channelid_ask": (
        "یک پست از کانال VIP را به اینجا فوروارد کن (با حفظ نام فرستنده).\n"
        "یا در خود کانال /channelid را بزن."
    ),
    "awiz_channelid_need_forward": "باید یک پست فورواردشده از کانال باشد. فوروارد کن یا انصراف بده.",
    ...
    "changelog_edit_prompt": (
        ...
        "پیام تو جایگزین کامل یادداشت‌های در صف می‌شود."
    ),
    "changelog_edit_saved": "✅ یادداشت‌های در صف به‌روز شد. دوباره بفرست، ویرایش کن، یا رد کن.",
    "changelog_edit_empty": "پیام خالی بود — متن یادداشت‌ها را بفرست تا جایگزین شود.",
    "changelog_edit_failed": "ذخیره یادداشت‌ها ممکن نشد. دوباره تلاش کن.",
