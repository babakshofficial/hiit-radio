...
STRINGS = {
    ...
    "help_text": (
        ...
        "Envoie /stop à tout moment pour arrêter un téléchargement."
    ),
    "aboutme_text": (
    ...
    "too_many_jobs": (
        ...
        "Attends qu'elles se terminent ou arrête-les avec /stop."
    ),
    ...
    "grant_user_notice": (
        "🎁 Tu as reçu {days} jours de {tier}, actif jusqu'au {expires}.\n"
        "Envoie un titre quand tu veux."
    ),
    "topup_user_notice": (
        "🎁 +{amount} téléchargements extra ont été ajoutés à ton compte pour aujourd'hui ({day})."
    ),
    "grant_notify_failed": (
        "⚠️ Impossible d'écrire à l'utilisateur — il doit peut-être d'abord lancer le bot."
    ),
    ...
    "playlist_start": (
        ...
        "Nombre : {total} titres\n\n"
        "/stop pour arrêter la tâche en cours"
    ),
    "playlist_capped": (
        "Cette playlist contient {original} titres. J'enverrai seulement les {limit} premiers."
    ),
    ...
    "progress_label_track": "Titre",
    "progress_label_download": "Téléchargement",
    "progress_label_playlist": "Playlist",
    "progress_label_similar": "Similaires",
    "progress_label_lyrics": "Paroles",
    "progress_label_discover": "Découvrir",
    "progress_searching": "Recherche...",
    "progress_searching_n": "Recherche ({current}/{total})...",
    "progress_downloading": "Téléchargement...",
    "progress_downloading_audio": "Téléchargement de l'audio...",
    "progress_preparing_link": "Préparation du lien...",
    "progress_starting_download": "Démarrage du téléchargement...",
    "progress_tagging": "Tags et pochette...",
    "progress_sending": "Envoi vers Telegram...",
    "progress_ready": "Prêt",
    "progress_cache_fast": "Envoi rapide depuis le cache...",
    "progress_ready_send": "Prêt à envoyer vers Telegram...",
    "progress_search_download": "Recherche et téléchargement...",
    "progress_preparing": "Préparation...",
    "progress_fetching_lyrics": "Récupération des paroles...",
    ...
    "awiz_cancel": "❌ Annuler",
    "awiz_confirm": "✅ Confirmer",
    "awiz_cancelled": "Annulé.",
    "awiz_invalid_user": "Ce n'est pas un ID utilisateur. Envoie un numéro, @username, ou choisis ci-dessous.",
    "awiz_pick_user": "Pour qui ?\nEnvoie un ID ou @username, ou choisis un utilisateur récent.",
    "awiz_grant_tier": "Accorder à {user} — quel forfait ?",
    "awiz_tier_premium": "⭐ Premium",
    "awiz_tier_unlimited": "♾ Illimité",
    "awiz_grant_days": "{user} → {tier}\nCombien de jours ?",
    "awiz_days_7": "7 jours",
    "awiz_days_30": "30 jours",
    "awiz_days_90": "90 jours",
    "awiz_days_custom": "Personnalisé…",
    "awiz_grant_days_custom": "Envoie le nombre de jours (ex. 14).",
    "awiz_grant_confirm": "Accorder {tier} à {user} pour {days} jours ?",
    "awiz_topup_amount": "Recharge pour {user} — combien de téléchargements en plus ?",
    "awiz_amt_default": "Défaut ({amount})",
    "awiz_amt_custom": "Personnalisé…",
    "awiz_topup_amount_custom": "Envoie le nombre de téléchargements extra.",
    "awiz_topup_confirm": "Ajouter +{amount} téléchargements aujourd'hui pour {user} ?",
    "awiz_broadcast_ask": "Envoie le texte de la diffusion dans le prochain message.",
    "awiz_broadcast_empty": "Message vide — envoie le texte à diffuser.",
    "awiz_broadcast_confirm": "Envoyer ceci à {count} utilisateurs ?\n\n{preview}",
    "awiz_broadcast_done": "Diffusion terminée : envoyés={sent}, échecs={failed}",
    "awiz_viplog_ask": "État du journal VIP :\n\n{status}\n\nEnvoyer un message test au canal VIP ?",
    "awiz_viplog_send": "🧪 Envoyer le test",
    "awiz_reports_ask": "Rapports utilisateurs — parcourir la liste, ou envoyer un ID.",
    "awiz_reports_list": "📋 Parcourir",
    "awiz_reports_id": "🔎 Saisir l'ID",
    "awiz_reports_ask_id": "Envoie l'ID du rapport (nombre).",
    "awiz_reports_bad_id": "ID invalide. Envoie un nombre, ou reviens en arrière.",
    "awiz_user_ask": "Envoie un ID ou @username, ou choisis un utilisateur récent.",
    "awiz_channelid_ask": (
        "Transfère ici un post du canal VIP (en gardant le nom de l'expéditeur).\n"
        "Ou envoie /channelid dans ce canal."
    ),
    "awiz_channelid_need_forward": "J'ai besoin d'un post transféré du canal. Transfère-en un, ou annule.",
    "awiz_export_ask": "Exporter toute la base en JSON ?",
    "awiz_export_go": "📤 Exporter",
    ...
    "changelog_edit_prompt": (
        ...
        "Ton message remplace entièrement les notes en attente."
    ),
    "changelog_edit_saved": "✅ Notes mises à jour. Envoie, modifie à nouveau, ou ignore.",
    "changelog_edit_empty": "Message vide — envoie le texte des notes pour remplacer le changelog.",
    "changelog_edit_failed": "Impossible d’enregistrer les notes. Réessaie.",
    "changelog_generating": "⏳ Génération des changelogs localisés…",
    "changelog_done": "Diffusion du changelog terminée : envoyés={sent}, échecs={failed}",
    "changelog_skipped": "Changelog ignoré. Les notes en attente ont été archivées.",
    "changelog_empty": "Aucune note de changelog en attente.",
    "changelog_llm_unavailable": (
        "Des notes de changelog sont en attente, mais le LLM n’est pas configuré.\n"
        "Définis LLM_API_KEY / LLM_API_BASE puis redémarre — ou ignore pour archiver."
    ),
    "changelog_llm_failed": (
        "Impossible de générer le changelog avec le LLM. Les notes restent en place."
    ),
    "changelog_busy": "Une diffusion de changelog est déjà en cours.",
    "changelog_forbidden": "Réservé à l’admin.",
    "changelog_btn_manual_new": "✍️ Nouveau changelog",
    "changelog_manual_intro": (
        "Aucune note en attente dans CHANGELOG_PENDING.md.\n"
        "Appuie sur Nouveau changelog, ou ajoute des notes dans le fichier repo et redémarre."
    ),
    "changelog_manual_prompt": (
        "Envoie les notes de changelog dans ton prochain message.\n"
        "L’anglais convient — le LLM localisera pour chaque langue.\n"
        "Tu reliras une carte par langue avant l’envoi."
    ),
